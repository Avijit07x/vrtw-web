...
import BlurText from "./reactBits/BlueText";
  ...
  return (
    <section className="relative px-6 py-20 pt-10 text-center">
      <div className="max-w-4xl mx-auto">
        ...
        <BlurText
          text="Create production-ready Vite + React + TailwindCSS v4 projects with one simple command. No configuration needed, just pure development bliss."
          delay={300} // Stagger the animation after the first one
          animateBy="words"
          direction="top"
